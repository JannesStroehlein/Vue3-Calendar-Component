...
<script setup lang="ts">
  ...
  import type { CalendarEventInternal, DateClickHandler, WeekViewEmits, WeekViewProps } from '@/plugin/types'
  import {
    formatEventTime,
    generateTimeSlots,
    getEventColor,
  ...
  const { handleDragStart: dragStart, handleDrop: drop } = useDragAndDrop(async (data) => {
